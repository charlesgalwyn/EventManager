...
export const signupUser = (user) => async (dispatch) => {
    try {
        ...
        const res = await axios.post(`https://playo-app-5s2g.onrender.com/auth/signup`, user);
...
export const loginUser = (user) => async (dispatch) => {
    try {
        ...
        const res = await axios.post(`https://playo-app-5s2g.onrender.com/auth/login`, user);
